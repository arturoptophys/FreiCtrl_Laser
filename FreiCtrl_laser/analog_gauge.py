...
from PyQt6.QtGui import QPolygon, QPolygonF, QColor, QPen, QFont, QPainter, QFontMetrics, QConicalGradient, \
    QRadialGradient, QFontDatabase
from PyQt6.QtCore import Qt, QTimer, QPoint, QPointF, QRect, QSize, QObject
...
class AnalogGaugeWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # BIG SCALE COLOR
        ################################################################################################
        self.bigScaleMarker = Qt.GlobalColor.black

        ################################################################################################
        # FINE SCALE COLOR
        ################################################################################################
        self.fineScaleColor = Qt.GlobalColor.black
        ...
        self.initial_scale_fontsize = 20
    ...
    def setGaugeTheme(self, Theme=1):
        ...
        if Theme == 1:
            self.set_scale_polygon_colors([[.75, Qt.GlobalColor.red],
                                           [.5, Qt.GlobalColor.yellow],
                                           [.25, Qt.GlobalColor.green]])
        ...
        if Theme == 2:
            self.set_scale_polygon_colors([[.25, Qt.GlobalColor.red],
                                           [.5, Qt.GlobalColor.yellow],
                                           [.75, Qt.GlobalColor.green]])
            ...
            self.set_scale_polygon_colors([[.00, Qt.GlobalColor.white]])
            ...
            self.set_scale_polygon_colors([[1, Qt.GlobalColor.black]])
            ...
            self.bigScaleMarker = Qt.GlobalColor.white
            self.fineScaleColor = Qt.GlobalColor.white
    ...
    def create_polygon_pie(self, outer_radius, inner_raduis, start, lenght, bar_graph=True):
        ...
        if not self.enableBarGraph and bar_graph:
            ...
            lenght = int(round((lenght / (self.maxValue - self.minValue)) * (int(self.value) - self.minValue)))
    ...
    def create_scale_marker_values_text(self):
        ...
        # painter.save()
        font = QFont(self.scale_fontname, self.scale_fontsize, QFont.Weight.Bold)
        ...
        for i in range(self.scalaCount + 1):
            ...
            h = fm.height()
            painter.setFont(QFont(self.scale_fontname, self.scale_fontsize, QFont.Weight.Bold))
    ...
    def create_values_text(self):
        ...
        # xShadow = 3.0
        # yShadow = 3.0
        font = QFont(self.value_fontname, self.value_fontsize, QFont.Weight.Bold)
        fm = QFontMetrics(font)
        ...
        # angle_distance = (float(self.scale_angle_size) / float(self.scalaCount))
        # for i in range(self.scalaCount + 1):
        text = f"{self.value:0.2f}"
        w = fm.horizontalAdvance(text) + 1
        h = fm.height()
        painter.setFont(QFont(self.value_fontname, self.value_fontsize, QFont.Weight.Bold))
    ...
    def create_units_text(self):
        ...
        painter.translate(self.width() / 2, self.height() / 2)
        font = QFont(self.value_fontname, int(self.value_fontsize / 2.5), QFont.Weight.Bold)
        fm = QFontMetrics(font)
        ...
        w = fm.horizontalAdvance(text) + 1
        h = fm.height()
        painter.setFont(QFont(self.value_fontname, int(self.value_fontsize / 2.5), QFont.Weight.Bold))
